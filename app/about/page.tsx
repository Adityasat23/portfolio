      ...
      <main className="max-w-5xl mx-auto space-y-24">
        ...
        <motion.section variants={staggerContainer} initial="hidden" animate="visible" className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <motion.div variants={fadeUp} className="md:col-span-8 space-y-6">
            ...
            <div className="pt-2">
              <a href="/cv-aditya.pdf" download className="inline-flex items-center gap-2 px-6 py-3.5 bg-neutral-900 dark:bg-neutral-100 text-white dark:text-neutral-950 font-medium rounded-full hover:scale-105 transition-transform duration-300 shadow-md">
