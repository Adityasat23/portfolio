  ...
  const experienceData = [
    {
      ...
      logo: "/logo-timephoria.png" // Siapkan logo di folder public
    },
    {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div variants={fadeUp} className="group">
              <Link href="/work/gemini" className="block space-y-4">
                <div className="aspect-[4/5] bg-neutral-200 dark:bg-neutral-800 border border-neutral-200/50 dark:border-neutral-800/50 rounded-3xl overflow-hidden relative shadow-lg transition-transform duration-500 group-hover:-translate-y-2">
                  ...
                  {/* <Image src="/thumb-gemini.jpg" alt="Google Gemini" fill className="object-cover" /> */}
                  <div className="absolute inset-0 flex items-center justify-center text-neutral-400 text-sm">Upload thumb-gemini.jpg</div>
            ...
            <motion.div variants={fadeUp} className="group">
              <Link href="/work/timephoria" className="block space-y-4">
                <div className="aspect-[4/5] bg-neutral-200 dark:bg-neutral-800 border border-neutral-200/50 dark:border-neutral-800/50 rounded-3xl overflow-hidden relative shadow-lg transition-transform duration-500 group-hover:-translate-y-2">
                  {/* <Image src="/thumb-timephoria.jpg" alt="TimePhoria" fill className="object-cover" /> */}
            ...
            <motion.div variants={fadeUp} className="group">
              <Link href="/work/nore" className="block space-y-4">
                <div className="aspect-[4/5] bg-neutral-200 dark:bg-neutral-800 border border-neutral-200/50 dark:border-neutral-800/50 rounded-3xl overflow-hidden relative shadow-lg transition-transform duration-500 group-hover:-translate-y-2">
                  {/* <Image src="/thumb-nore.jpg" alt="Nore Inovasi" fill className="object-cover" /> */}
